...
toward the
mean*](https://en.wikipedia.org/wiki/Regression_toward_the_mean) is
relevant when predicting biological age, and how it can lead to invalid
conclusions when it is ignored. This document first introduces the
concept of regression to the mean. It is explained why this unavoidable
phenomenon is especially relevant in the context of biological age
prediction. Finally, with artificially created data it is shown how this
phenomenon can lead to wrong conclusions when interpreting the
difference between true and predicted chronological age as an indication
of accelerated/decelerated biological aging.
